...
export default function LabOverlay() {
  ...
  return <>
    <div className={`scene-motion ${paused ? "is-paused" : ""}`} aria-hidden="true">
      ...
      <div className="walker"><span className="walker-head"/><span className="walker-body"/><span className="walker-arm walker-arm-a"/><span className="walker-arm walker-arm-b"/><span className="walker-leg walker-leg-a"/><span className="walker-leg walker-leg-b"/></div>
